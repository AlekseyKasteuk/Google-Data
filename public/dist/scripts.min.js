var app=angular.module("GoogleData",["ui.router","ui.tinymce","ngMaterial","ngMessages","ngFileUpload","ngImgCrop","ui.calendar"]);app.config(["$httpProvider","$urlRouterProvider","$stateProvider","$locationProvider","$mdIconProvider","$mdThemingProvider",function(e,t,a,r,o,l){t.otherwise("/profile"),a.state("login",{url:"/login",templateUrl:"application/states/login/login.html",controller:"LoginCtrl"}).state("app",{url:"/",templateUrl:"application/states/app/app.html",controller:"AppCtrl",redirectTo:"app.profile"}).state("app.profile",{url:"profile?account",templateUrl:"application/states/app/profile/profile.html",controller:"ProfileCtrl"}).state("app.messages",{url:"messages?labels",templateUrl:"application/states/app/messages/messages.html",controller:"MessagesCtrl"}).state("app.message",{url:"messages/:id",templateUrl:"application/states/app/messages/id/message.html",controller:"MessageCtrl"}).state("app.calendar",{url:"calendar",templateUrl:"application/states/app/calendar/calendar.html",controller:"CalendarCtrl"}),l.theme("default").primaryPalette("blue").accentPalette("indigo")}]),app.run(["$rootScope","$state","$stateParams","authService",function(e,t,a,r){e.getRange=function(e,t){return t=t?t:{},"birth year"==e?_.range(moment().year(),moment().year()-120):"birth month"==e?moment.months():"birth date"==e&&t.year&&t.month?_.range(1,moment().year(t.year).month(t.month).daysInMonth()+1):[]},e.$on("$stateChangeStart",function(a,o,l){r.checkAuth().success(function(a){return e.authorizedUser=a,o.redirectTo?(console.log(o.redirectTo),void t.go(o.redirectTo,l)):void("login"==o.name&&t.go("app"))}).error(function(){e.authorizedUser=void 0,"login"!=o.name&&t.go("login")})})}]);
...
app.factory("innerCalendarServ",["$http",function(e){return{create:function(n){return e.post("/calendar/inner/create",n)},createEvent:function(n){return e.post("/events/internal/create",n)}}}]);
...
app.directive("calendarListItem",[function(){return{restrict:"AE",scope:{calendarListItem:"=",calendarSection:"@",calendarCreateAction:"="},templateUrl:"/application/directives/calendar_list_item/calendar_list_item.html"}}]);
app.directive("calendarTodayClick",["$timeout",function(t){return{restrict:"A",link:function(n,c){$(c).ready(function(){t(function(){$(".fc-today-button").click()},100)})}}}]);
...
app.controller("createEventCtrl",["$scope","$mdDialog","calendarData","innerCalendarServ",function(a,e,n,t){console.log(n),a.event={start:n.start.toDate(),end:n.start.clone().add(1,"d").toDate(),allDay:!0},a.calendarConfigs=n,a.cancel=function(){e.cancel()},a.save=function(){if("internal"==a.calendarType){console.log(a.event);var n=angular.copy(a.event);n.start=moment(n.start).format("YYYY-MM-DD HH:mm:ss"),n.end=moment(n.end).format("YYYY-MM-DD HH:mm:ss"),n.color=n.calendar.backgroundColor||"blue",n.all_day=n.allDay,n.calendar=n.calendar.id,t.createEvent(n).success(function(){e.hide()})}else"google"==a.calendarType}}]);
app.controller("createInnerCalendarCtrl",["$scope","innerCalendarServ","$mdDialog",function(e,n,a){e.calendar={},e.create=function(){console.log(e.calendar),e.calendar.name&&e.calendar.color&&n.create(e.calendar).success(function(){a.hide()})},e.cancel=function(){a.cancel()}}]);
...
app.controller("CalendarCtrl",["$scope","calendarService","uiCalendarConfig","$compile","$mdDialog",function(e,n,t,a,l){$(".fc-today-button").click();var o,r=function(){n.getCalendars(moment(o.intervalStart).format("YYYY-MM-DDTHH:mm:ss[Z]"),moment(o.intervalEnd).format("YYYY-MM-DDTHH:mm:ss[Z]")).success(function(n){console.log(n),e.calendars.google=n.google.calendars.items,e.calendars.internal=n.inner.calendars,e.events.splice(0,e.events.length-1),n.google.events.forEach(function(n){e.events.push(n)}),n.inner.events.forEach(function(n){e.events.push(n)})})},c=function(n){l.show({controller:"createEventCtrl",templateUrl:"application/modal_dialogs/create_event/create_event.html",parent:angular.element(document.body),targetEvent:event,clickOutsideToClose:!0,fullscreen:!0,locals:{calendarData:{internalCalendars:e.calendars.internal,googleCalendars:e.calendars.google.filter(function(e){return"owner"==e.accessRole}),start:n}}}).then(function(){r()})};e.calendars={google:[]},e.events=[],e.eventSources=[e.events],e.uiConfig={calendar:{height:850,header:{left:"month agendaWeek agendaDay",center:"title",right:"today prev,next"},viewRender:function(e,n){o=e,r()},eventRender:function(n,t,l){console.log("Event Render"),t.attr({tooltip:n.title,"tooltip-append-to-body":!0}),a(t)(e)},dayClick:function(e){c(e)}}},e.createInnerCalendar=function(){l.show({controller:"createInnerCalendarCtrl",templateUrl:"application/modal_dialogs/create_inner_calendar/create_inner_calendar.html",parent:angular.element(document.body),targetEvent:event,clickOutsideToClose:!0,fullscreen:!0}).then(function(){r()})},e.createGoogleCalendar=function(){}}]);
